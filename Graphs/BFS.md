...
## Complessità
L'algoritmo è utilizzabile sia su grafi orientati, sia su quelli non orientati e il peso degli archi non influenza la BFS. Esso viene impiegato nell'Algoritmo di Dijkstra (ciò non implica che non si possa usare Dijkstra in una BFS se è necessario trovare il percorso ottimale).
